...
public class UnitLength extends AppCompatActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dot:
                ...
                return;
            case R.id.equal:
                int item12 = this.s1.getSelectedItemPosition();
    ...
    public double evaluate(int item1, int item2, double value) {
        ...
        switch (item1) {
            case 0:
                temp = this.ca.NanoToMeter(value);
                break;
            case 1:
                temp = this.ca.MilliToMeter(value);
                break;
            case 2:
                temp = this.ca.CentiToMeter(value);
                break;
            case 3:
                temp = value;
                break;
            case 4:
                temp = this.ca.KiloToMeter(value);
                break;
            case 5:
                temp = this.ca.InchToMeter(value);
                break;
            case 6:
                temp = this.ca.FootToMeter(value);
                break;
            case 7:
                temp = this.ca.YardToMeter(value);
                break;
            case 8:
                temp = this.ca.MileToMeter(value);
                break;
        }
        switch (item2) {
            case 0:
                return this.ca.MeterToNano(temp);
            case 1:
                return this.ca.MeterToMilli(temp);
            case 2:
                return this.ca.MeterToCenti(temp);
            case 3:
            default:
                return temp;
            case 4:
                return this.ca.MeterToKilo(temp);
            case 5:
                return this.ca.MeterToInch(temp);
            case 6:
                return this.ca.MeterToFoot(temp);
            case 7:
                return this.ca.MeterToYard(temp);
            case 8:
                return this.ca.MeterToMile(temp);
        }
    }
}
